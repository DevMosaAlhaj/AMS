...
namespace AMS.Infrastructure.Service.AuthServices
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IMapper mapper, UserManager<UserDbEntity> userManager, SignInManager<UserDbEntity> signInManager, IOptions<MyJwtBearerOptions> options, AmsDbContext dbContext)
        {
            _mapper = mapper;
